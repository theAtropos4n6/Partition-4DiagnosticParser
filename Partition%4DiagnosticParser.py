...
def fullparse():
	...
	try: #checkarw an einai legit evtx log
		...
		if IsPartitionDiagnosticEVTXFullParse:			
			...
			FullParsehtml_code += f'\n</table> \n<br>\n<table align="left">\n <tr style="background-color:DarkGrey"> <th colspan="2">Log Timeline</th>\n <tr><td>From:</td> <td>{FullParseLogStartTime}</td>\n<tr><td>To:</td> <td>{FullParseLogEndTime}</td>\n</table> \n<br> <br> <br>\n<div class="push"></div> \n</div> \n <div class="footer">--Partition%4DiagnosticParser Ver. 1.3.0</div>\n</body>\n</html>'
					...
					if IsPartitionDiagnosticEVTX: #parsarw giati einai to PartitionDiagnostic evtx afou ola ta EventID einai 1006
						...
						if isDiskPlugedin == False:
							...
							if values['-HTMLCHK-']: # an exei tickarei to checkbox gia html report
								HTMLTicked = True
								HTMLWritten = True
								html_code += f'\n</table> \n<br>\n<table align="left">\n <tr style="background-color:DarkGrey"> <th colspan="2">Log Timeline</th>\n <tr><td>From:</td> <td>{LogStartTime}</td>\n<tr><td>To:</td> <td>{LogEndTime}</td>\n</table> \n<br> <br> <br> \n<div class="push"></div> \n</div> \n <div class="footer">--Partition%4DiagnosticParser Ver. 1.3.0</div>\n</body>\n</html>'
